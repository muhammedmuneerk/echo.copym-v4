  ...
  return (
    <section className="relative bg-green-50 py-20 lg:py-0 overflow-hidden">
      ...
      <div className="w-full px-4 sm:px-6 lg:px-12 relative z-10">
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-3xl p-8 lg:p-16 shadow-lg relative overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center relative z-10">
            <div className="text-center lg:text-left lg:-mt-12 lg:ml-4">
