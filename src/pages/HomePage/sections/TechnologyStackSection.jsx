      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
          <div className="bg-gray-50 p-6 rounded-xl shadow hover:shadow-md transition">
            <h4 className="text-xl font-semibold text-gray-800 mb-2">Multi-Chain Infrastructure</h4>
          ...
          <div className="bg-gray-50 p-6 rounded-xl shadow hover:shadow-md transition">
            <h4 className="text-xl font-semibold text-gray-800 mb-2">Smart Contract Transparency</h4>
            <p className="text-gray-600 text-sm">
          ...
          <div className="bg-gray-50 p-6 rounded-xl shadow hover:shadow-md transition">
            <h4 className="text-xl font-semibold text-gray-800 mb-2">Custodial & Non-Custodial Options</h4>
            <p className="text-gray-600 text-sm">
          ...
          <div className="bg-gray-50 p-6 rounded-xl shadow hover:shadow-md transition">
            <h4 className="text-xl font-semibold text-gray-800 mb-2">Audits & Security Standards</h4>
            <p className="text-gray-600 text-sm">
