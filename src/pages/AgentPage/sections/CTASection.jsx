      ...
      <div className="max-w-7xl mx-auto px-8 relative z-10">
        <div className="space-y-16">
          ...
          >
            <div className="mb-12">
              <div className="mb-8">
                <TrendingUp className="text-green-400 text-6xl mx-auto mb-6 animate-pulse" />
              </div>
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-white flex items-center justify-center gap-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              {[
                ...
                <motion.div
                  ...
                  className="bg-gradient-to-br from-gray-800 to-gray-900 border border-white/10 rounded-2xl p-10 text-center transition-all duration-400 ease-out hover:-translate-y-3 hover:shadow-2xl hover:shadow-black/30 hover:from-gray-700 hover:to-gray-800 relative overflow-hidden backdrop-blur-md group"
                >
                  {/* Top border gradient */}
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  ...
                  <div
                    key={index}
                    className="flex items-center gap-4 p-4 bg-black/30 border border-white/10 rounded-xl transition-all duration-300 ease-out hover:bg-black/40 hover:border-green-400/30 hover:translate-x-2"
                  >
          ...
          >
            <div className="flex gap-6 justify-center mb-8 flex-wrap">
              <button 
                ...
                className="inline-flex items-center justify-center px-8 py-5 text-xl font-bold border-2 border-transparent rounded-2xl text-black bg-gradient-to-br from-green-400 to-green-500 shadow-xl shadow-green-400/30 min-w-[320px] relative overflow-hidden transition-all duration-400 ease-out hover:from-green-500 hover:to-green-600 hover:-translate-y-2 hover:shadow-2xl hover:shadow-green-400/40 active:scale-95 uppercase tracking-wider"
              >
              ...
              <button 
                ...
                className="inline-flex items-center justify-center px-8 py-5 text-xl font-bold border-2 border-white/20 rounded-2xl text-white bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md min-w-[320px] relative overflow-hidden transition-all duration-400 ease-out hover:bg-white/15 hover:border-white/40 hover:-translate-y-2 hover:shadow-2xl hover:shadow-white/10 active:scale-95 uppercase tracking-wider"
              >
            ...
            <div className="flex gap-4 justify-center flex-wrap">
              {[
                ...
                <span
                  key={index}
                  className="inline-flex items-center gap-2 bg-black/50 text-gray-400 px-4 py-3 rounded-full text-sm font-medium border border-white/10 transition-all duration-300 ease-out hover:bg-green-400/10 hover:text-green-400 hover:border-green-400/30 hover:-translate-y-1"
                >
                  {requirement.icon}
                  {requirement.text}
                </span>
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-red-400/10 to-red-500/10 border border-red-400/20 rounded-2xl p-8 animate-pulse"
            style={{
          ...
          >
            <div className="flex items-center gap-6 justify-center">
              <div className="flex-shrink-0 animate-pulse">
                <Timer className="text-red-400 text-4xl" />
              </div>
              <div className="text-center">
                <h4 className="text-2xl font-bold text-red-400 mb-2 flex items-center justify-center gap-2">
