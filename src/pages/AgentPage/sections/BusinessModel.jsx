    ...
    <section className="bg-gray-900 py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {revenueStreams.map((stream, index) => (
            <motion.div
              ...
              className="bg-gray-800 border border-gray-700 rounded-xl p-8 text-center transition-all duration-300 hover:transform hover:-translate-y-1 hover:border-green-400 hover:shadow-lg hover:shadow-green-400/10"
            >
        ...
        <motion.div
          ...
          className="text-center bg-green-400 text-black py-6 px-8 rounded-xl text-lg font-semibold"
        >
          <p>
